...
@Component({
  selector: 'app-review10',
  templateUrl: './review10.page.html',
  styleUrls: ['./review10.page.scss'],
})
export class Review10Page {
  ...
  { 
    this.review.comment = '';
    this.review.score = '';
    this.review.id_attr = 12;
    this.review.name_attr = "วัดศรีสุพรรณ";
    this.loaddata(12);  
    this.dataUser();
