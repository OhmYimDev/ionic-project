...
@Component({
  selector: 'app-checkin5',
  templateUrl: './checkin5.page.html',
  styleUrls: ['./checkin5.page.scss'],
})
export class Checkin5Page {
  ...
  showmap(){
    const location = new google.maps.LatLng(18.796704,98.982788);
    const options = {
      center: location,
      zoom: 15,
