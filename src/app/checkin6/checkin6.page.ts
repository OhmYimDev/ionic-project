...
@Component({
  selector: 'app-checkin6',
  templateUrl: './checkin6.page.html',
  styleUrls: ['./checkin6.page.scss'],
})
export class Checkin6Page {
  ...
  markers: any = [
    {
      title: "พิพิธภัณฑสถานแห่งชาติเชียงใหม่",
      latitude: "18.8114732",
      longitude: "98.9740984"
    }
  ]
  ...
  showmap(){
    const location = new google.maps.LatLng(18.8114732,98.9740984);
    const options = {
      center: location,
      zoom: 15,
