...
@Component({
  selector: 'app-checkin10',
  templateUrl: './checkin10.page.html',
  styleUrls: ['./checkin10.page.scss'],
})
export class Checkin10Page {
  ...
  showmap(){
    const location = new google.maps.LatLng(18.778708,98.983653);
    const options = {
      center: location,
      zoom: 15,
  ...
  insertdata(){
    ...
    if (this.checkin.datetime != '' ) 
    {
      ...
      data.subscribe(data =>{
        ...
        this.ShowAlert();
        this.navCtrl.navigateBack("/srisuphan");
      });
    }
  }
  async ShowAlert() {
