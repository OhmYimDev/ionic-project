...
@Component({
  selector: 'app-checkin3',
  templateUrl: './checkin3.page.html',
  styleUrls: ['./checkin3.page.scss'],
})
export class Checkin3Page {
  ...
  showmap(){
    const location = new google.maps.LatLng(18.80903,98.971916);
    const options = {
      center: location,
      zoom: 15,
