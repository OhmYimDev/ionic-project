...
@Component({
  selector: 'app-review7',
  templateUrl: './review7.page.html',
  styleUrls: ['./review7.page.scss'],
})
export class Review7Page {
  ...
  { 
    this.review.comment = '';
    this.review.score = '';
    this.review.id_attr = 9;
    this.loaddata(9);  
    this.dataUser();
    this.loaddata_score(9);
    this.load_countreviews(9);
    this.review.name_attr = "ศูนย์วัฒนธรรมเชียงใหม่";
  }
