...
@Component({
  selector: 'app-review9',
  templateUrl: './review9.page.html',
  styleUrls: ['./review9.page.scss'],
})
export class Review9Page {
  ...
  { 
    this.review.comment = '';
    this.review.score = '';
    this.review.id_attr = 11;
    this.loaddata(11);  
    this.dataUser();
    this.loaddata_score(11);
    this.load_countreviews(11);
    this.review.name_attr = "เวียงกุมกาม";
  }
