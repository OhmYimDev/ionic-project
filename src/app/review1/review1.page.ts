...
@Component({
  ...
  templateUrl: './review1.page.html',
  styleUrls: ['./review1.page.scss'],
})
export class Review1Page {
  ...
  { 
    this.review.comment = '';
    this.review.score = '';
    this.review.id_attr = 3;
    this.review.name_attr = "วัดพระธาตุดอยสุเทพราชวรวิหาร";
    this.loaddata(3);  
    this.loaddata_score(3);
    this.load_countreviews(3);
    this.dataUser();
  }
