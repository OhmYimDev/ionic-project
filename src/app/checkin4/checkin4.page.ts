...
@Component({
  selector: 'app-checkin4',
  templateUrl: './checkin4.page.html',
  styleUrls: ['./checkin4.page.scss'],
})
export class Checkin4Page {
  ...
  showmap(){
    const location = new google.maps.LatLng(18.786917,98.986507);
    const options = {
      center: location,
      zoom: 15,
  ...
  insertdata(){
    ...
    if (this.checkin.datetime != '' ) 
    {
      ...
      let url: string = 'https://www.comdept.cmru.ac.th/60143227/insert-checkin.php';
