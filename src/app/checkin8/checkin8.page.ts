...
@Component({
  selector: 'app-checkin8',
  templateUrl: './checkin8.page.html',
  styleUrls: ['./checkin8.page.scss'],
})
export class Checkin8Page {
  ...
  showmap(){
    const location = new google.maps.LatLng(18.748028,98.924919);
    const options = {
      center: location,
      zoom: 15,
