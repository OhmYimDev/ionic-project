...
@Component({
  selector: 'app-checkin2',
  templateUrl: './checkin2.page.html',
  styleUrls: ['./checkin2.page.scss'],
})
export class Checkin2Page {
  ...
  showmap(){
    const location = new google.maps.LatLng(18.788592,98.981237);
    const options = {
      center: location,
      zoom: 15,
